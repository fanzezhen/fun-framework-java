...
import com.github.fanzezhen.fun.framework.core.enums.FunFrameworkExceptionEnum;
import com.github.fanzezhen.fun.framework.core.util.CommonUtil;
        ...
        if (result.size() < tasks.size()) {
            ...
            futureMap.forEach((task, future) -> {
                try {
                    ...
                    ServiceException exception = new ServiceException(FunFrameworkExceptionEnum.ASYNC_ERROR_THREAD_TERMINATE_ABNORMALLY);
                    if (throwAllowed) {
                        throw exception;
                    }
                }
