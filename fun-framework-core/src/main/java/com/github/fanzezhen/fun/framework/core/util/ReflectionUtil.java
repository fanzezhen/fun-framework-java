...
import com.github.fanzezhen.fun.framework.core.model.bean.AttributeBean;
...
public class ReflectionUtil {
     ...
     * @return HashMap
     */
    public static Map<String, Object> javaBeanToHashMap(Object javaBean) {
    ...
    public static Map<String, HashMap<String, Object>> getDiff(Object before, Object after, AbstractDict dict, boolean isGetAll) {
    ...
    public static Map<String, Object> extractByDict(Object o, AbstractDict dict) {
        HashMap<String, Object> result = new HashMap<>(8);
        Map<String, Object> map = javaBeanToHashMap(o);
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            String key = entry.getKey();
            if (dict.containsKey(key)) {
                result.put(dict.get(key), entry.getValue());
            }
        }
        return result;
    }
