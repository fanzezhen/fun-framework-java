...
public final class ElasticsearchScriptConstants {
    ...
    private ElasticsearchScriptConstants() {
     ...
     * <p>执行阶段:Map 阶段开始时</p>
     */
    public static final String INIT_SCRIPT = "state.groupMap = new HashMap();";
     ...
     * <p>适用场景:简单的字段值频次统计</p>
     */
    public static final String MAP_SCRIPT_COUNT_TEMPLATE = """
        ...
        """;
    public static final String MAP_SCRIPT_SUM_TEMPLATE = """
        
                    if (doc['%s'].size() > 0 && doc['%s'].size() > 0) {
                      def value = doc['%s'].value;
                      state.statistics.put(value, state.statistics.getOrDefault(value, 0) + doc['%s'].value);
                    }
        """;
     ...
     */
    public static final String MAP_SCRIPT_COUNT_DOC_TEMPLATE = """
     ...
     */
    public static final String MAP_SCRIPT_HIT_SORT_TEMPLATE = """
     ...
     */
    public static final String SCRIPT_HIT_SORT_TEMPLATE = """
                          docList.sort((a, b) -> {
     ...
     * </p>
     */
    public static final String OBJECT_SORT_ASC_SCRIPT = """
     ...
     * </p>
     */
    public static final String OBJECT_SORT_DESC_SCRIPT = """
                            if (sortValue1 instanceof Number && sortValue2 instanceof Number) {
     ...
     * <p>执行阶段:Map 阶段</p>
     */
    public static final String MAP_SCRIPT_DEFAULT_DOC = """
     ...
     * </p>
     */
    public static final String MAP_SCRIPT_DOC_ITEM_TEMPLATE = """
     ...
     */
    public static final String MAP_SCRIPT_COMBINE_SCRIPT = """
     ...
     */
    public static final String REDUCE_SCRIPT_TEMPLATE = """
     ...
     */
    public static final String REDUCE_SCRIPT_SORT_ASC_TEMPLATE = "resultList.sort((a, b) -> a.doc_count - b.doc_count);";
     ...
     */
    public static final String REDUCE_SCRIPT_SORT_DESC_TEMPLATE = "resultList.sort((a, b) -> b.doc_count - a.doc_count);";
     ...
     */
    public static final String REDUCE_SCRIPT_LIMIT_TEMPLATE = """
     ...
     */
    public static final String REDUCE_SCRIPT_UNSORTED_TEMPLATE = """
     ...
     * @see #REDUCE_SCRIPT_DESCENDING_TEMPLATE 降序版本
     */
    public static final String REDUCE_SCRIPT_ASCENDING_TEMPLATE = """
     ...
     * @see #REDUCE_SCRIPT_ASCENDING_TEMPLATE 升序版本
     */
    public static final String REDUCE_SCRIPT_DESCENDING_TEMPLATE = """
