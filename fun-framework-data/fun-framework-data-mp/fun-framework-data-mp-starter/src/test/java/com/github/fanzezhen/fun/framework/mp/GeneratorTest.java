    ...
    void testGenerator() {
        ...
        Assertions.assertDoesNotThrow(() ->
            Generator.fastAutoGenerator(Generator.Config.ofTable(
                "jdbc:mysql://ip:port/tmp?serverTimezone=Asia/Shanghai&characterEncoding=UTF-8&useUnicode=true&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true",
                "",
                "",
